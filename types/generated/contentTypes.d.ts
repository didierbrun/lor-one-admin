...
export interface ApiFooterContentFooterContent extends Schema.SingleType {
  ...
  attributes: {
    ...
    network_title: Attribute.Text & Attribute.Required;
    link_mensa_france: Attribute.String & Attribute.Required;
    link_mensa_international: Attribute.String & Attribute.Required;
    webmaster_title: Attribute.String & Attribute.Required;
    version_label: Attribute.String & Attribute.Required;
    technical_contact: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiHomeContentHomeContent extends Schema.SingleType {
  ...
  attributes: {
    ...
    seo: Attribute.Component<'navigation.seo'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
